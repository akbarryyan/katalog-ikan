  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-[#00412E] via-[#00412E]/95 to-[#96BF8A] text-white">
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-16 lg:py-20">
          ...
          <div className="space-y-8 sm:space-y-0 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-8 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-2">
              <div className="flex flex-col items-center sm:items-start mb-6">
                ...
                <div className="text-center sm:text-left">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-3" style={{ fontFamily: 'Hanken Grotesk' }}>
            ...
            <div className="text-center sm:text-left">
              <h4 className="text-lg sm:text-xl font-bold mb-6 flex items-center justify-center sm:justify-start" style={{ fontFamily: 'Hanken Grotesk' }}>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex items-center justify-center sm:justify-start group">
                  ...
                  <span className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">Ikan Segar Berkualitas</span>
                </div>
                <div className="flex items-center justify-center sm:justify-start group">
                  <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center mr-3 group-hover:bg-white/20 transition-all duration-200">
                    <span className="text-lg">🚚</span>
                  </div>
                  <span className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">Pengiriman Cepat</span>
                </div>
                <div className="flex items-center justify-center sm:justify-start group">
                  <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center mr-3 group-hover:bg-white/20 transition-all duration-200">
                    <span className="text-lg">💯</span>
                  </div>
                  <span className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">Garansi Kualitas</span>
                </div>
                <div className="flex items-center justify-center sm:justify-start group">
                  <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center mr-3 group-hover:bg-white/20 transition-all duration-200">
                    <span className="text-lg">📞</span>
                  </div>
                  <span className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">Layanan 24/7</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center sm:justify-start group">
                  ...
                  <div>
                    <div className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">Email</div>
                    <div className="text-white/70 text-xs">admin@ikanoni.com</div>
                  </div>
                </div>
                <div className="flex items-center justify-center sm:justify-start group">
                  <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center mr-3 group-hover:bg-white/20 transition-all duration-200">
                  ...
                  <div>
                    <div className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">WhatsApp</div>
                    <div className="text-white/70 text-xs">+62 812-3456-7890</div>
                  </div>
                </div>
                <div className="flex items-center justify-center sm:justify-start group">
                  <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center mr-3 group-hover:bg-white/20 transition-all duration-200">
                  ...
                  <div>
                    <div className="text-white/90 font-medium text-sm group-hover:text-white transition-colors duration-200">Alamat</div>
                    <div className="text-white/70 text-xs">Jakarta, Indonesia</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-10 sm:h-16 fill-white">
